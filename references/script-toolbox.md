...
- `render_character.py`
  ...
  - In v10 it can also emit `KERNEL.md`, `PERFORMANCE.md`, `OOC_NEGATIVES.md`, and `BENCHMARK.md`; `MEMORY.md` and `DEVELOPMENT.md` are emitted only when long-term development is explicitly enabled.
