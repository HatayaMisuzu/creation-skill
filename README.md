...
- 支持萌娘百科等中文 ACG 信息源，用于确认中文人名、别名、术语和企划信息。
- 蒸馏角色人格、表达 DNA、关系、边界和世界观。
- 生成可直接运行的 `CHARACTER.md`。
- 让角色对话更有张力、更立体、更沉浸。
- 固定角色外貌细节、多套衣着，并允许 AI 在不违和的范围内按状态和场景调整穿搭。
...
APPEARANCE.md          # 外貌细节、固定衣着、自由搭配规则
...
- **中文译名谨慎处理**：人名、企划名、地点、技能、歌曲、章节等专名优先采用官方中文和萌娘百科等中文信息源，不随意机翻或自造译名。
...
- **视觉不漂移**：发色、瞳色、标志配饰、制服规则等稳定外貌要素不能被随意改写；AI 自由搭配必须遵守角色风格语法。
